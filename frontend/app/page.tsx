            ...
            <div className="mx-auto max-w-5xl space-y-8">
              ...
              >
                ...
                <h1 className="text-4xl md:text-[4rem] font-bold font-caveat text-slate-900 leading-[0.9] mb-1">
                  All your PDF headache in <br className="hidden md:block" />
                  <motion.span
                  ...
                  >
                    ...
                    >
                      <div className="relative">
                        <svg className="absolute -left-16 top-4 w-12 h-10 text-[#FF0000]" viewBox="0 0 50 40">
                        ...
                        <div className="font-caveat text-[#FF0000] text-base md:text-lg leading-tight text-left transform rotate-6">
                          <div>0.00 Rs / month</div>
                          <div>keep your wallet safe</div>
                        </div>
                      </div>
                    </motion.div>
                    <motion.div
                      className="absolute -bottom-4 left-0 w-full h-[0.5em] text-[#01B0F1] -z-10 opacity-60"
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
              ...
              >
                <h2 className="text-2xl md:text-[2.5rem] font-bold font-caveat text-slate-900 leading-none">
                  Simple, super, and{" "}
                  <motion.span
                    className="relative inline-block text-[#01B0F1]"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  >
                    ...
                    >
                      <svg viewBox="0 0 100 10" className="w-full h-4 text-[#01B0F1]" preserveAspectRatio="none">
                        <path d="M0,5 Q50,10 100,5" fill="none" stroke="currentColor" strokeWidth="5" />
                      </svg>
                    </motion.div>
                  </motion.span>
                </h2>
              ...
              <ScrollReveal delay={0.3}>
                <div className="mt-6 mb-2 flex flex-col md:flex-row items-center justify-between gap-6 px-4">
                  ...
                  >
                    ...
                    <span className="text-base font-medium text-slate-700">Just imagine life without 18+ PDF?</span>
                  </motion.div>
