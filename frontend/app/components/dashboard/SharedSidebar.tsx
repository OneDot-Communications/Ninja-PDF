...
export function SharedSidebar({ className, type }: SharedSidebarProps) {
    ...
    const adminLinks = [
        ...
        { href: "/admin/features", label: "Feature Matrix", icon: ShieldCheck },
    ...
    const superAdminLinks = [
        ...
        { href: "/super-admin/features", label: "Feature Matrix", icon: ShieldCheck },
        { href: "/super-admin/subscriptions", label: "Global Revenue", icon: CreditCard },
        { href: "/super-admin/activity", label: "System Activity", icon: Activity },
